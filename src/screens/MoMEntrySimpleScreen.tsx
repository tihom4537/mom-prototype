...
export default function MoMEntrySimpleScreen() {
  ...
  const handleAcceptRewrite = () => {
    ...
    setDiscussionText(feedbackResult.rewrite);
    updatedTextRef.current = feedbackResult.rewrite;
                ...
                {feedbackResult.rewrite && (
                  <div className="flex flex-col gap-[10px] shrink-0 w-full">
                    ...
                    <FeedbackCard
                      ...
                      segments={parseSegments(feedbackResult.rewrite)}
                      isActive={false}

...
export default function MoMEntrySimpleScreenV5() {
  ...
  // Everything in the left column above/below the discussion textarea (heading,
  // agenda card, labels, decision point field, footer buttons) — measured so the
  // discussion textarea can be sized to exactly fill the remainder needed to
  // match the feedback column's height.
  ...
  // TOTAL height matches the feedback column's natural content height — content
  // beyond that scrolls inside the textarea rather than growing the page.
      ...
      <div className="flex flex-col gap-[3px]">
        ...
        <div ref={gridRef} className="bg-white grid gap-[32px] p-[30px] rounded-bl-[15px] rounded-br-[15px]" style={{ gridTemplateColumns: isFeedbackApplicable ? '1fr 460px' : '1fr', alignItems: 'start' }}>
          ...
          <div ref={leftColRef} className="flex flex-col gap-[20px] min-w-0">
            ...
            <div ref={leftExtraBottomRef} className="flex flex-col gap-[20px] w-full">

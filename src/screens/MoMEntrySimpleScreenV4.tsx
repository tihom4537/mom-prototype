...
export default function MoMEntrySimpleScreenV4() {
  ...
  const [selectedAction,    setSelectedAction]    = useState<
    'action_option_approval' | 'action_option_discussion' | 'action_option_information' | null
  >(null);
  ...
  return (
    <MeetingShellLayout stepperActiveState={2} showBack={false}>
      <div className="flex flex-col gap-[3px]">
        ...
        <div ref={gridRef} className="bg-white grid gap-[32px] p-[30px] rounded-bl-[15px] rounded-br-[15px]" style={{ gridTemplateColumns: '1fr 460px', alignItems: 'start' }}>
